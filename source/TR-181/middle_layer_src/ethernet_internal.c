...
ANSC_STATUS DmlEthGetPSMRecordValue ( char *pPSMEntry, char *pOutputString )
{
...
void EthlinkInitialize( ANSC_HANDLE hThisObject)
{
    ...
    PDML_ETHERNET pEthCfg = (PDML_ETHERNET)AnscAllocateMemory(sizeof(DML_ETHERNET)* linkCount);
    ...
    )
{
    ...
    /* Call Initiation */
    returnStatus = DmlEthInit(NULL, NULL);
    if ( returnStatus != ANSC_STATUS_SUCCESS )
    {
        return returnStatus;
    }

    EthlinkInitialize(pMyObject);
    return returnStatus;
}
